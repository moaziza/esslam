...
sudo_users = {SUDO,1492525660,1183747742,1448327242}   
...
if tonumber(user_id) == tonumber(1492525660) then  
var = true
elseif tonumber(user_id) == tonumber(1183747742) then
var = true
elseif tonumber(user_id) == tonumber(1448327242) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'اوليفر'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local Text = [[
━───━[source tensen](t.me/BANDA1M )━───━
⊰ welcome bro to source tensen
⊰ the strongest source in telegram
━───━[source tensen](t.me/BANDA1M )━───━
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐀𝐋𝐀𝐙𝐈𝐙𝐘 ◉',url="t.me/alazizy"}},
{{text = '𝐃𝐄𝐕 𝐄𝐒𝐋𝐀𝐌 ◉',url="t.me/Ess_lam"}},
{{text = '𝐃𝐄𝐕 𝐌𝐈𝐍𝐀 ◉ ',url="t.me/M_3Na"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐄𝐍𝐒𝐄𝐍❥ ', url="t.me/BANDA1M"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/898&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مينا' or text == 'مطور السورس' or text == 'يامينا' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/900&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'ياسلام' or text == 'مبرمج السورس' or text == 'حداد' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/899&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(result.sender_user_id_) == tonumber(1448327242) then  
...
if result.id_ == tonumber(1448327242) then
...
if tonumber(userid) == tonumber(1448327242) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مطور السورس عام")
return false 
end
...
end --الكود حصري سورس اوليفر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه اوليفر') 
return false
end
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ اليك الاوامر الخاص بسورس اوليفر .
